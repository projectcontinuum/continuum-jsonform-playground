...
// Upstream imports the base schema/uischema/data from categorization.ts and
// layers `options: { variant: 'stepper', showNavButtons: true }` onto the
// root Categorization uischema; the base categorization is inlined here.
const examples: PlaygroundExample[] = [
  {
    name: 'JSONForms: Categorization (Stepper - Nav Buttons)',
    schema: {
      type: 'object',
      properties: {
        firstName: {
